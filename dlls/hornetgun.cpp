...
void CHgun::PrimaryAttack()
{
	...
	pHornet->pev->velocity = gpGlobals->v_forward * 1000;

	m_flRechargeTime = gpGlobals->time + 0.07;
#endif
...
void CHgun::SecondaryAttack( void )
{
	...
	m_flRechargeTime = gpGlobals->time + 0.035;
#endif
	...
	m_flNextPrimaryAttack = m_flNextSecondaryAttack = UTIL_WeaponTimeBase() + 0.035;
	m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + UTIL_SharedRandomFloat( m_pPlayer->random_seed, 10, 15 );
}
