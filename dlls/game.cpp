...
cvar_t	sk_healthcharger1	= { "sk_healthcharger1","100" };		
cvar_t	sk_healthcharger2	= { "sk_healthcharger2","100" };		
cvar_t	sk_healthcharger3	= { "sk_healthcharger3","100" };		

cvar_t	sk_healthkit1	= { "sk_healthkit1","50" };		
cvar_t	sk_healthkit2	= { "sk_healthkit2","50" };		
cvar_t	sk_healthkit3	= { "sk_healthkit3","50" };		
...
cvar_t	sk_monster_head1	= { "sk_monster_head1","3" };
cvar_t	sk_monster_head2	= { "sk_monster_head2","3" };
cvar_t	sk_monster_head3	= { "sk_monster_head3","3" };
