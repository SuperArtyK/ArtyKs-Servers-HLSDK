...
#ifndef CLIENT_DLL
#define BOLT_AIR_VELOCITY	700
#define BOLT_WATER_VELOCITY	700
...
void CCrossbowBolt::BoltTouch( CBaseEntity *pOther )
{
	...
	if (pOther->pev->takedamage)
	{
		...
		if ( pOther->IsPlayer() )
		{
			pOther->TraceAttack(pevOwner, gSkillData.plrDmgCrossbowClient, pev->velocity.Normalize(), &tr, DMG_ALWAYSGIB);
		}
		else
		{
			pOther->TraceAttack(pevOwner, gSkillData.plrDmgCrossbowMonster, pev->velocity.Normalize(), &tr, DMG_BULLET | DMG_ALWAYSGIB);
		}
